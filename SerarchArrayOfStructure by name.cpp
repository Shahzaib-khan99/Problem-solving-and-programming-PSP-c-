...
const int size = 5;	// Maximum of 5 students in class
...
void Search(student[],int , char[]);// array of record, size of array of stuct, student number you want to search
...
int main()
{
	...
	cout<<"\n\n enter student Name you wanted to search=";
	gets(sname);
	cout<< "===============================================\n";
	cout<< "====Calling Search Function====\n";

	Search(stu,size , sname);// calling search function
	cout<<"\n\n\n\n\n\n";
...
///////////////////////////////////////////////////////////
void Search(student s1[],int n, char sname[])				//n=size of array of structure
